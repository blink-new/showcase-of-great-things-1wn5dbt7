...
import { 
  ...
  ChevronUp, Star, Briefcase, GraduationCap
} from 'lucide-react';
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <form className="space-y-6 bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-200/50 dark:border-gray-700/50">
